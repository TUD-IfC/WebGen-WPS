...
/** ********************************************************************* */	
	...
	/** ********************************************************************* */
	/**
	 * Funktion vergrössert Polygon auf Mindestgrösse
	...
	public static Polygon skaleSize(Polygon polygon, double targetSize) {		
		double threshold = Math.abs(targetSize/100.0); 	// Schwellwert für Genauigkeit von 1%
		...
		/* 1. Schwerpunkts- und Flächenberechnung der Originalfläche */
		...
		while(Math.abs(targetSize - area) > threshold) {
			...
			// c) Berechnen des oberen Skalierungsfaktors falls nötig
...
//			System.out.println(" | " + area + " | " + scaleFactor);
		...
		/* 4. Skaliertes Polygon auf ursprünglichen Schwerpunkt verschieben */    
