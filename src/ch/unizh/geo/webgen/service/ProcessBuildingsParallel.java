...
import ch.unizh.geo.webgen.service.parallel.RemotePartitionThread;
import ch.unizh.geo.webgen.tools.ProcessingTools;

import com.vividsolutions.jump.feature.FeatureCollection;

public class ProcessBuildingsParallel extends AWebGenAlgorithm implements IWebGenAlgorithm {
	...
	public InterfaceDescription getInterfaceDescription() {
		InterfaceDescription id = new InterfaceDescription("ProcessBuildingsParallel", "neun", "processing",
				"",
				"ProcessBuildingsParallel",
