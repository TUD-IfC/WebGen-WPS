...
public class JTSsymDifference extends AWebGenAlgorithm implements IWebGenAlgorithm {
	...
	public InterfaceDescription getInterfaceDescription() {
		InterfaceDescription id = new InterfaceDescription("JTSsymDifference", "neun", "support",
				"",
				"JTSsymDifference",
				"JTSsymDifference",
				"1.0");
