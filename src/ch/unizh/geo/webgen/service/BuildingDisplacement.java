...
public class BuildingDisplacement extends AWebGenAlgorithm implements IWebGenAlgorithm  {
	...
	public InterfaceDescription getInterfaceDescription() {
		InterfaceDescription id = new InterfaceDescription("BuildingDisplacement", "neun", "operator",
				"",
		...
		id.addOutputParameter("result", "FeatureCollection", new AttributeDescription("GEOMETRY", "GEOMETRY", allowed), "output geometries");
		return id;
	}
}
