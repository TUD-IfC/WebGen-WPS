...
public class JTSDifference extends AWebGenAlgorithm implements IWebGenAlgorithm {
	...
	public InterfaceDescription getInterfaceDescription() {
		InterfaceDescription id = new InterfaceDescription("JTSDifference", "neun", "support",
				"",
				"JTSDifference",
				"JTSDifference",
				"1.0");
		...
		id.addOutputParameter("result", "FeatureCollection", new AttributeDescription("GEOMETRY", "GEOMETRY", allowed), "jts differenced geometries"); //test
		return id;
	}
}