...
public class BuildingSimplification extends AWebGenAlgorithm implements IWebGenAlgorithm {
	...
	public InterfaceDescription getInterfaceDescription() {
		InterfaceDescription id = new InterfaceDescription("BuildingSimplification", "neun", "operator",
				"",
