...
public class ShrinkAllPolygons extends AWebGenAlgorithm implements IWebGenAlgorithm {
	...
	public InterfaceDescription getInterfaceDescription() {
		InterfaceDescription id = new InterfaceDescription("ShrinkAllPolygons", "neun", "operator",
				"",
				"ShrinkAllPolygons",
				"Shrink all polygons",
				"1.0");
